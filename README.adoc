...
`SUBSIDY_RATE`: determine the amount of ICX held in the contract for subsidizing the final prize, in form of percentage. Formula below

[source]
FINAL_PRIZE = MONEY_POT_AFTER_COMMISSION + MONEY_POT_AFTER_COMMISSION * SUBSIDY_RATE / 100
...
* `SUBSIDY_RATE` is *50%*, funded by ICONVIET
